...
@Component({
  selector: 'app-boostrap-carousel',
  templateUrl: './boostrap-carousel.component.html',
  styleUrls: ['./boostrap-carousel.component.css']
})
export class BoostrapCarouselComponent {
  ...
  public addSlide(slide: SlideCarouselComponent) {
  ...
  public removeSlide(slide: SlideCarouselComponent) {
